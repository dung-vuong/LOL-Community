...
const Detail = ({postDetails}: IProps) => {
    ...
    return (
        <div className='flex w-full absolute left-0 top-0 bg-white flex-wrap lg:flex-nowrap'>
            <div className='relative flex-2 w-[1000px] lg:w-9/12 flex justify-center items-center bg-gray-500 '>
                ...
                <div className='absolute bottom-5 lg:bottom-7 right-5 lg:right-10  cursor-pointer'>
                    {isVideoMuted ? (
